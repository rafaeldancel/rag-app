...
import { UpsertAnnotationInputSchema, GetAnnotationsInputSchema, ListAnnotationsInputSchema, DeleteAnnotationInputSchema, AnnotationSchema, } from '@repo/shared';
// ─── Router ───────────────────────────────────────────────────────────────────
export const annotationsRouter = router({
    ...
    upsert: publicProcedure
        ...
        if (input.verseText !== undefined)
            update.verseText = input.verseText;
