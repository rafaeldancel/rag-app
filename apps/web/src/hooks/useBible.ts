...
export function useVotd(versionId = BIBLE_VERSIONS.NIV) {
...
export function useDailyPrayer(versionId = BIBLE_VERSIONS.NIV) {
...
export function useBooks(versionId = BIBLE_VERSIONS.NIV) {
...
export function useBibleChapter(book: string, chapter: number, versionId = BIBLE_VERSIONS.NIV) {
