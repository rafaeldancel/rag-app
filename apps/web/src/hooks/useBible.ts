...
export function useVotd(versionId = BIBLE_VERSIONS.BSB) {
...
export function useDailyPrayer(versionId = BIBLE_VERSIONS.BSB) {
...
export function useBooks(versionId = BIBLE_VERSIONS.BSB) {
...
export function useBibleChapter(book: string, chapter: number, versionId = BIBLE_VERSIONS.BSB) {
